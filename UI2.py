...
def GetParser():
    ...
    parser_active.set_defaults(func=handle_active)
    ...
    parser_passive.set_defaults(func=handle_passive)
    ...
    parser_ind.set_defaults(func=handle_ind)
    return parser
